...
```bash
$ mvn com.github.myoss.maven.plugins:archetypes-maven-plugin:1.0.3.RELEASE:springBootSingleProject -Ddirectory='/Users/jerry/workspaces/github/myoss/myoss-java/phoenix-maven-plugin/archetypes-maven-plugin/target' \
...
```bash
$ mvn com.github.myoss.maven.plugins:archetypes-maven-plugin:1.0.3.RELEASE:shareProject -Ddirectory='/Users/jerry/workspaces/github/myoss/myoss-java/phoenix-maven-plugin/archetypes-maven-plugin/target' \
...
```bash
$ mvn com.github.myoss.maven.plugins:archetypes-maven-plugin:1.0.3.RELEASE:springBootMultiModuleProject -Ddirectory='/Users/jerry/workspaces/github/myoss/myoss-java/phoenix-maven-plugin/archetypes-maven-plugin/target' \
