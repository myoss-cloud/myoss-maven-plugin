...
```bash
$ mvn app.myoss.cloud.maven.plugins:archetypes-maven-plugin:2.1.0.RELEASE:springBootSingleProject -Ddirectory='/Users/jerry/workspaces/github/myoss/myoss-java/myoss-maven-plugin/archetypes-maven-plugin/target' \
...
```bash
mvn app.myoss.cloud.maven.plugins:archetypes-maven-plugin:2.1.0.RELEASE:springBootSingleProject ^
...
```bash
$ mvn app.myoss.cloud.maven.plugins:archetypes-maven-plugin:2.1.0.RELEASE:shareProject -Ddirectory='/Users/jerry/workspaces/github/myoss/myoss-java/myoss-maven-plugin/archetypes-maven-plugin/target' \
...
```bash
mvn app.myoss.cloud.maven.plugins:archetypes-maven-plugin:2.1.0.RELEASE:shareProject ^
-Ddirectory="C:\Users\jerry\logs\archetypes-maven-plugin" ^
...
```bash
$ mvn app.myoss.cloud.maven.plugins:archetypes-maven-plugin:2.1.0.RELEASE:springBootMultiModuleProject -Ddirectory='/Users/jerry/workspaces/github/myoss/myoss-java/myoss-maven-plugin/archetypes-maven-plugin/target' \
...
```bash
mvn app.myoss.cloud.maven.plugins:archetypes-maven-plugin:2.1.0.RELEASE:springBootMultiModuleProject ^
-Ddirectory="C:\Users\jerry\logs\archetypes-maven-plugin" ^
